(function (Sinco) {
    ...
    var iconos = {
        ...
        Clip: function (dim, bgColor) {
            dim = dim || 25;
            bgColor = bgColor || '#1B344C';
            return SvgBasico((dim * 25) / 47, dim, bgColor, '0 0 25 47', 'm20.66669,11.5l0,23c0,4.42 -3.58,8 -8,8s-8,-3.58 -8,-8l0,-25c0,-2.76 2.24,-5 5,-5s5,2.24 5,5l0,21c0,1.1 -0.89,2 -2,2c-1.11,0 -2,-0.9 -2,-2l0,-19l-3,0l0,19c0,2.76 2.24,5 5,5s5,-2.24 5,-5l0,-21c0,-4.42 -3.58,-8 -8,-8s-8,3.58 -8,8l0,25c0,6.08 4.93,11 11,11s11,-4.92 11,-11l0,-23l-3,0z');
        },
